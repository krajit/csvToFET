...
# as a first attempt add all electives students in courses
print('Adding students in their compulsory courses ......')
for ci in courseList:
    c = courseList[ci]
    if ci in courseElectiveStudents:
        cElectiveStudents = courseElectiveStudents[ci]
        for sg in cElectiveStudents:
            c['studentsSet'] = c['studentsSet'].union(cElectiveStudents[sg])
